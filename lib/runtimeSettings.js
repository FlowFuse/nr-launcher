function getSettingsFile (settings) {
    ...
    if (settings.settings) {
        ...
        if (settings.settings.palette?.allowList !== undefined) {
            projectSettings.palette.allowList = settings.settings.palette.allowList.split(',').map(fn => fn.trim()).filter(fn => fn.length > 0)
        }
        if (settings.settings.palette?.denyList !== undefined) {
            projectSettings.palette.denyList = settings.settings.palette.denyList.split(',').map(fn => fn.trim()).filter(fn => fn.length > 0)
        }
        if (settings.settings.modules?.allowList !== undefined) {
            projectSettings.modules.allowList = settings.settings.modules.allowList.split(',').map(fn => fn.trim()).filter(fn => fn.length > 0)
        }
        if (settings.settings.modules?.denyList !== undefined) {
            projectSettings.modules.denyList = settings.settings.modules.denyList.split(',').map(fn => fn.trim()).filter(fn => fn.length > 0)
        }
    }
