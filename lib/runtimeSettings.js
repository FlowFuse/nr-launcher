...
module.exports = {
    ...
    httpAdminMiddleware: function(req,res,next) {
        res.set("Content-Security-Policy", "frame-ancestors 'self' *.flowforge.cloud *.other.flowfuse:* *.other.flowforge:*");
        res.set("X-Frame-Options", "allow-from *.flowforge.cloud *.other.flowfuse:* *.other.flowforge:*");
        next()
    }
}
`
