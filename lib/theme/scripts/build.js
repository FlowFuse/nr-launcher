...
*/`
    ...
    if (options.out) {
        ...
        console.log(output.css.toString()) // eslint-disable-line no-console
    }
...
function showUsageAndExit (exitCode) {
    console.info('')
    console.info('Usage:   build [-?] [--src=PATH]')
    console.info('Example: npm run build-theme -- --src=../src/node-red')
    console.info('Example: node build.js --src=../src/node-red')
    console.info('')
    console.info('Options:')
    console.info('  --src        PATH  Path to src of node-red')
